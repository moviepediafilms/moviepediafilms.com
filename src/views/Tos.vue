<template>
  <base-layout>
    <div class="q-ma-md q-pt-lg">
      <h2 class="text-primary mt-5 text-uppercase text-center">
        Terms of Services
      </h2>
      ...
      <p>
        ...
        (&ldquo;you&rdquo;) and [Moviepedia Films](&ldquo;we,&rdquo;
        &ldquo;us&rdquo; or &ldquo;our&rdquo;), concerning your access to and
        use of the [moviepediafilms.com] website as well as any other media
      ...
      <p>
        ...
        or modifications to these Terms of Service at any time and for any
        reason.
      </p>
      <p>
        We will alert you about any changes by updating the &ldquo;Last
        updated&rdquo; date of these Terms of Service, and you waive any right
      ...
      <p>
        ...
        in these Terms of Service, no part of the Site and no Content or Marks
      ...
      <p>
        ...
        Distributor&rdquo;) to access the Site:
      </p>
      <p>
      ...
      <p>
        ...
        Terms of Service of this mobile application license contained in these
        Terms of Service or as otherwise required under applicable law, and you
      ...
      <p>
        ...
        the applicable Terms of Service that govern your use of each Third-Party
        Account.
      </p>
      <p>
      ...
      <p>
        ...
        &ldquo;Social Network Content&rdquo;) so that it is available on and
      ...
      <p>
        ...
        Digital Millennium Copyright Act (&ldquo;DMCA&rdquo;) Notice and Policy
        ...
        simply provide the space to place such advertisements, and we have no
      ...
      <p>
        All Notifications should meet the requirements of DMCA 17 U.S.C. &sect;
      ...
      <p>
        ...
        using the contact information provided below (a &ldquo;Counter
        Notification&rdquo;).
      </p>
      <p>
      ...
      <p>
        ...
        state]applicable to agreements made and to be entirely performed within
      ...
      <p>
        ...
        by either you or us (collectively, the &ldquo;Parties&rdquo; and
        individually, a &ldquo;Party&rdquo;) shall be commenced or prosecuted in
        the state and federal courts located in [name of county] County, [name
        of state], and the Parties hereby consent to, and waive all defenses of
      ...
      <p>
        ...
        related in any way to the Site be commenced more than ______ years after
      ...
      <p>
        ...
        or claim related to these Terms of Service (each a "Dispute" and
        collectively, the &ldquo;Disputes&rdquo;) brought by either you or us
        (individually, a &ldquo;Party&rdquo; and collectively, the
        &ldquo;Parties&rdquo;), the Parties agree to first attempt to negotiate
        any Dispute (except those Disputes expressly provided below) informally
        for at least
        <strong>______</strong> days before initiating arbitration. Such
      ...
      <p>
        ...
        where appropriate, the AAA&rsquo;s Supplementary Procedures for Consumer
      ...
      <p>
        ...
        to the Site be commenced more than _____ years after the cause of action
      ...
      <p>
        To expedite resolution and control the cost of any dispute, controversy
        or claim related to these Terms of Service (each a "Dispute" and
        collectively, &ldquo;Disputes&rdquo;), any Dispute brought by either you
        or us (individually, a &ldquo;Party&rdquo; and collectively, the
        &ldquo;Parties&rdquo;) shall be finally and exclusively resolved by
        binding arbitration.
      </p>
      <p>
        YOU UNDERSTAND THAT WITHOUT THIS PROVISION, YOU WOULD HAVE THE RIGHT TO
        ...
        Arbitration Association ("AAA") and, where appropriate, the AAA&rsquo;s
      ...
      <p>
        ...
        the Site or Services be commenced more than ______ years after the cause
        of action arose.
      </p>
      <p>
      ...
      <p>
        ...
        PAID, IF ANY, BY YOU TO US DURING THE [_________] MONTH PERIOD PRIOR TO
        ANY CAUSE OF ACTION ARISING [OR] [$_________]. CERTAIN STATE LAWS DO NOT
      ...
      <p>
        ...
        Service; (4) any breach of your representations and warranties set forth
        in these Terms of Service; (5) your violation of the rights of a third
      ...
      <p>
        ...
        on the Site constitute the entire agreement and understanding between
      ...
      <p>
        ...
        information regarding use of the Site, please reach out to us via any
        medium listed under contact us section below
      </p>
    </div>
  </base-layout>
</template>
