...
const routes = [
  ...
  },
  {
    path: "/mdff",
    name: "mdff",
    component: () => import("../views/mdff.vue"),
  },
  {
    path: "/welcome",
    name: "welcome",
  ...
  {
    path: "/events/iim-rohtak-2024",
    name: "event-iim-rohtak-2024",
    component: () => import("../views/events/IIMRohtak2024.vue"),
  },
  {
    path: "/login",
    name: "login",
  ...
  },
  {
    path: "/list/:id/:slug/",
    name: "list-detail",
    component: () => import("../views/CurationListDetail.vue"),
  },
  {
    path: "/reviews/:id/",
    name: "reviews",
  ...
  },
  {
    ...
    component: () => import("../views/MoviesByProfile.vue"),
  },
  {
    path: "/partner-judges",
    name: "partner-judges",
  ...
  },
  {
    path: "/top-curator",
    name: "top-curator",
    component: () => import("../views/TopCurator.vue"),
  },
  {
  ...
  },
  {
    ...
    component: () => import("../views/AudienceLeaderboard.vue"),
  },
  {
    path: "/filmmaker-leaderboard",
    name: "filmmaker-leaderboard",
    component: () => import("../views/FilmmakerLeaderboard.vue"),
  },
  {
    path: "/movie-by-genre/:genre",
    name: "movies-by-genre",
    component: () => import("../views/MpGenre.vue"),
  },
  // static pages below
  {
    path: "/about",
  ...
  },
  {
    ...
    component: () => import("../views/RulesAndRegulations.vue"),
  },
  {
    path: "*",
    name: "not-found",
